...
func main() {
	...
	fmt.Println("Avarage bandwidth usage:", dash.AverageBandWidth())
	fmt.Println("Avarage cpu temp:", dash.AverageCpuTemp())
	fmt.Println("Avarage memory usage:", dash.AverageMemoryUsage())
}
